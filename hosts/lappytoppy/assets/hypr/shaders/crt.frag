// crt shader for hyprland (https://github.com/hyprland-community/awesome-hyprland/issues/22#issuecomment-1665703581) based on https://github.com/sigma-957/hyprland-shaders/blob/main/crt.frag
...
#define CHROMATIC_ABERRATION_STRENGTH 0.0027
